...
def get_forward_backward_func():
    ...
    if pipeline_model_parallel_size > 1:
        ...
        print("this is for one gpu in schedule.py in line 103!!")
...
def forward_step(
    ...
    print('output_tensor  is loss not real output tennsor wtf  size ,',output_tensor.size())
    print('\n\n')
    ...
    if parallel_state.is_pipeline_last_stage():
        if not collect_non_loss_data:
            ...
            print("loss function output tenso==========1r",output_tensor)
        else:
            data = loss_func(output_tensor, non_loss_data=True)
            forward_data_store.append(data)
            print("loss function output tenso==========2r",output_tensor)
...
def backward_step(input_tensor, output_tensor, output_tensor_grad, model_type, config):
    ...
    print("back step input_tensor-------------------------->",input_tensor)
    print("back step output_tensor-------------------------->",output_tensor)
    print("back step output_tensor_grad-------------------------->",output_tensor_grad)
    ...
    if  config.deallocate_pipeline_outputs:
        ...
        print("\n\n\n\n")
        print("type********************",type(output_tensor_grad[0]))
        print(output_tensor_grad[0])
        print("*********************************************")
        ...
        print("*********************************************")
       # custom_backward(output_tensor[0], output_tensor_grad[0])
        print('------------------grad---------',output_tensor[0])
        #output_tensor[0].backward()
        torch.autograd.backward(output_tensor[0], grad_tensors=output_tensor_grad[0])
        print(output_tensor[0].grad)
...
def forward_backward_no_pipelining(
    *,
    ...
    """
    print("This is a log in the schedule.py in the line 311")
    ...
    #print("this is config file in the forword back function in the schedules.py and the line is 350")
    ...
    with no_sync_func():
        for i in range(num_microbatches - 1):
            ...
            print("output_tensor in the for loop :::::::::::",output_tensor)
            if not forward_only:
    ...
    #print('forward_step_func',forward_step_func)
    output_tensor = forward_step(
        forward_step_func,
        data_iterator,
        model,
    ...
    print("this is forward  only : ",forward_only)
    if not forward_only:
        backward_step(input_tensor, output_tensor, output_tensor_grad, model_type, config)
    ...
    print('forward_data_store',forward_data_store)
