...
def generate_tokens_probs_and_return_on_first_stage_candidate(
        model, tokens, lengths,target_id,
    ...
    target_id = torch.tensor([[  40,  765,  284,  711,  329,  262, 1074,  326,  314]], device='cuda:0')
    ...
    print("output_log_probs--------> in 287", output_log_probs)
    if return_output_log_probs:
